...
Arthub Ensor is a fork of the [Arthub Flanders](https://arthub.vlaamsekunstcollectie.be) platform ([Github project](https://github.com/vlaamsekunstcollectie/Arthub-Frontend/tree/iiif-testbed)), a customised [Project Blacklight](https://github.com/projectblacklight/blacklight) installation written in Ruby on Rails. It utilises an [Imagehub](https://github.com/Hero-Solutions/ImageHub/tree/ensor) installation to generate [IIIF Presentation API](https://iiif.io/api/presentation/2.1/) manifests in order to display high-resolution images.
