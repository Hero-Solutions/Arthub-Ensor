...
Arthub Ensor is a fork of the [Arthub Flanders](https://arthub.vlaamsekunstcollectie.be) platform, a customised [Project Blacklight](https://github.com/projectblacklight/blacklight) installation written in Ruby on Rails. It utilizes a customized [Imagehub](https://github.com/Hero-Solutions/ImageHub/tree/ensor) installation to generate [IIIF Presentation API](https://iiif.io/api/presentation/2.1/) in order to display high-resolution images.
